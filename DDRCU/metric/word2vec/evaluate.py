...
class Embedding(object):
    def __init__(self):
        # Word2Vec 포맷 파일 경로 설정
        path = './'
        file_name = 'glove.6B.300d.word2vec.txt'
        full_path = "metric/word2vec/glove.6B.300d.word2vec.txt"

        print(f"Trying to load: {full_path}")
        self.m = KeyedVectors.load_word2vec_format(full_path, binary=False)
